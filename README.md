# Projeto DSList - Intensivão Java Spring (Back-End).

## Sobre o projeto:

**Treinamento 100% gratuito: Intensivão Java Spring.**

A aplicação consiste em um sistema onde você pode organizar seus jogos, permitindo que você mude a posição deles na coleção. Evento organizado pela [DevSuperior](https://github.com/devsuperior).
